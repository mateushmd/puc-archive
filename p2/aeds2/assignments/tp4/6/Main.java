...
class HashTable
{
    ...
    {
        return ascii(pokemonName) % size;
    }

    private int rehash(String pokemonName)
    {
        return (ascii(pokemonName) + 1) % size;
    }
    ...
    public SearchResult search(String pokemonName)
    {
        ...
        if(pokedex[idx] != null && pokedex[idx].getName().equals(pokemonName))
        {
...
public class Main 
{
    public static void main(String[] args) throws IOException
    {
        ...
        FileUtil.writeFile("842536_hashRehash.txt",
